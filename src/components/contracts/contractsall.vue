<template>
    <div class="v-contractsall">
        ...
        <!--列表-->
        <Table stripe border :columns="columns" :data="_contracts" ></Table>
        <!--分页-->
        ...
        <Modal  v-model="modalNew" width="400" title="新增合同"
            ...
            <br>
            <Row>
                <Col span="4"><span class="padding-left-8 padding-top-6 color-red">客户单位</span></Col>
                <Col span="12">
        ...
        <Modal  v-model="modalEdit" width="400" title="编辑合同"
            ...
            <Row>
                ...
                <Upload
                        ...
                        :headers="headers"
                        :name="uploadName"
                        :default-file-list="singleEdit.file"
                        :on-success="handleSuccess"
                        :on-error="handleError"
                        :on-remove="handleRemove">
                    <div style="padding: 20px 0">
            ...
            return {
                ...
                columns:[
                    ...
                    },
                    {
                        ...
                        render (row, column, index) {
                            return `
                                    <i-button type="info" size="small" @click="info(${index})">基本描述</i-button>
...
//                n.parentId = n.cus.id
            ...
            edit(){
                ...
                //contractsall提供了选择客户单位的能力
                n.customer_id = n.cus ? n.cus.payload.id : n.customer_id
                n.customer_name = n.cus ? n.cus.payload.name : n.customer_name
